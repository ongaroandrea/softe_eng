...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body("category").notEmpty().isIn(["Smartphone", "Laptop", "Appliance"]),
            body("quantity").isInt({ min: 1 }),
            body("sellingPrice").isFloat({ gt: 0 }),
            body("arrivalDate").optional().isDate(),
        ...
        this.router.patch(
            ...
            body("quantity").isInt({ min: 1 }),
            body("changeDate").optional().isDate(),
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            param("model").isString().notEmpty(),
            body("quantity").isInt({ min: 1 }),
            body("sellingDate").optional().isDate(),
            this.errorHandler.validateRequest,
